...
public class Condicional {
    public static void main(String[] args) {
        ...
        */
                ...
                System.out.println("Ingreso 3 números, que sean enteros, por favor.");
                System.out.println("Declarando 2 números positivos y uno negativo");
                System.out.println("(en cualquier orden)");
                nro1=teclado.nextInt();
                nro2=teclado.nextInt();
                nro3=teclado.nextInt();
if (nro1>0){
    System.out.println("El resultado de las multiplicación de números positivos es: "+nro2*nro3);
}else if (nro2<0) {
    System.out.println("El resultado de las multiplicación de números positivos es: "+nro1*nro3);
}else { 
   System.out.println("El resultado de las multiplicación de números positivos es: "+nro1*nro2); 
}    
        ...
        // si quisieramos identificar un color de acuerdo con el siguiete esquema;
        ...
        //la estructura switch reeemplaza a la estructura if-else if-else
        //el comando break genera un corte en la secuencia de comandos
        //y saca el código de la codigo de la estructura
        //el valor por valor por default es el valor por defecto si no encuentra
        ...
        default: System.out.println("El dia no existe");
        
        //en los casos en los que no hay break funcionaría como OR
        
        String opcion="s";
        switch (opcion){
            //Toma la s minúscula y la mayúscula
            case "s":
            case "S":
        ...
        switch (dia){
            case 1,2,3,4,5:
                System.out.println("Es día de semnana"); break; 
            case 6,7:
                System.out.println("Es fin de semnana"); break;
            default:
...
// se elimina la sentencia break
        ...
        mensaje =switch(dia){
            ...
            case 3 -> "El día es miercoles";
            case 4 -> "El día es jueves";
            case 5 -> "El día es viernes";
            case 6 -> "El día es sabado";
