...
*/
create database negocioVerspectino;
use negocioVerspectino;
...
create table clientes(
    ...
    ('Julia','Gutierrez','55555555','Belgrano 89'),
...
('C',3,4,'1990-06-21',21000),
('C',4,8,curdate(),78000);

-- el producto cartesiano, es la union de todos los registros.
...
-- El join que utilizamos se lo conoce tambien como INNER JOIN 
-- une las dos tablas pr medio de una colmna en comun.
-- Compara los valores si se encuentra una coincidencia, los selecciona.
-- Comparando con la teoría de los conjuntos, vendría a ser la intersección.
